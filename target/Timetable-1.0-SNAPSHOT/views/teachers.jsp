                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="myModalLabel">Modifier ce professeur</h4>
                        </div>
                                ...
                                <div class="align-center">
                                    <label for="addTitle">
                                        <select id="editTitle" name="typeTeacher" class="selectpicker mform" data-live-search="true">
                                            <option value="1">Deparetement de physique </option>
                                            <option value="2">Departement TRI</option>
                                            <option value="3">Deparetement d'Electricité</option>
                                            <option value="4">Deparetement magnetisme</option>
                                            <option value="5">Deparetement de civile</option>
                                        </select>
                                    </label>
                                </div>
                                <div align="center">
            ...
            <div class="modal fade" id="teacherDeleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="myModalLabel5">Est vous sur de suprimer ce professeur?</h4>
                        </div>
                        <br>
                        <div>
                            <div align="center">
            ...
            <div class="modal fade" id="teacherAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="myModalLabel2">Ajouter un nouveau professeur</h4>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                    <div>
