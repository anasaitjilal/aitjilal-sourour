...
<section id="container">
    <header style="background-color: #245269" class="header black-bg">
        ...
        <div style="background-color: #245269" class="top-menu">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a href="/timetable/subjects">Modules</a></li>
                        <li><a href="/timetable/classrooms">Classes</a></li>
                    </ul>
                </li>
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3 class="pull-left"><i class="fa fa-angle-right"></i> Modules</h3>
                    ...
                    <div class="content-panel">
                        <table class="table table-striped table-advance table-hover table-responsive">
                            ...
                            <tr>
                                ...
                                <%--<th>ID</th>--%>
                                <th>Nom du module</th>
                                <th>Pourcentage de comptabilisation </th>
                                <th>Pofesseurs</th>
                                <th></th>
                            </tr>
                            </thead>
            ...
            <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="myModalLabel3">Ajouter ce professeur a ce module </h4>
                        </div>
                        <div class="modal-body">
            ...
            <div class="modal fade" id="subjectDeleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="myModalLabel5">Est ce que vous voulez supprimer ce module ?</h4>
                        </div>
                        <br>
                        <div>
                            <div align="center">
            ...
            <div class="modal fade" id="subjectAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="myModalLabel2">Ajouter un nouveau module </h4>
                        </div>
                        <div class="modal-body">
                                <div class="form-group">
                                    <div>
