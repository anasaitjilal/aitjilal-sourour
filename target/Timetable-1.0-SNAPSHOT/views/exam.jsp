...
<section id="container">
    ...
    <header style="background-color: #245269" class="header black-bg">
        ...
        <div  style="background-color: #245269" class="top-menu">
            <ul style="background-color: #245269" class="nav pull-right top-menu">
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row mt">
                <div class="col-md-12">
                    <div class="form-panel">
                        <h4 class="mb"><i class="fa fa-angle-right"></i> Add exams aleatoire </h4>
            ...
            <div class="form-panel">
                ...
                <form:form method="post" action="/addd/examm" modelAttribute="exam" role="form"
                           class="form-inline">
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-3">
            ...
            <div class="special">
                <div class="col-sm-10 col-sm-offset-1 mt">
                    ...
                    <c:if test="${!empty exams}">
                        ...
                        <p align="center"><a class="btn btn-md btn-success" href="/pdf/${teacherId}" role="button">telecharger les pv d'examen</a></p>
                        <br/>
                        <br/>
                        <br/>
                    </c:if>
