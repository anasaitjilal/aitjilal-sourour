...
<section id="container">
        ...
        <div id="sidebar" class="nav-collapse ">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li class="active"><a href="/timetable/groups">Groupes</a></li>
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3 class="pull-left"><i class="fa fa-angle-right"></i> GROUPES</h3>
            ...
            <div class="modal fade" id="groupAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="myModalLabel2">Ajouter un nouveau groupe</h4>
                        </div>
                        <div class="modal-body">
                                <div class="form-group">
                                    <div>
                                ...
                                <div align="center">
                                    <button type="addbtnClose" class="btn btn-default" data-dismiss="modal">Fermer</button>
        ...
        <form method="POST" th:action="@{/anas/upload}" enctype="multipart/form-data">
