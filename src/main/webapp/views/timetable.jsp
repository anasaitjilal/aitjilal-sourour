            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a class="active" href="javascript:;">
                        ...
                        <span>Creation des emploi du temps</span>
                    </a>
                    <!--
                    <ul class="sub">
                    ...
                    <c:if test="${!empty lessons}">
                        <div class="content-panel">
                            ...
                            <c:if test="${mode == 'teacher'}">
                                <h3 align="center"><i class="fa fa-angle-right"></i>  for teacher: ${teacherName} ${teacherSecondname}</h3>
                            </c:if>
                            <br>
                        ...
                        <p align="center"><a class="btn btn-md btn-success" href="/pdf/${teacherId}" role="button">pdf</a></p>
                        <br/>
                        <br/>
                        <br/>
                        <p align="center"><a class="btn btn-md btn-success" href="/" role="button">Go to se</a></p>
                    </c:if>
                </div>
                <br>
                <br>
